        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-sans text-xl text-gray-300 mb-8 leading-relaxed">
                  Venda de Areia Ensacada com o melhor custo-benefício do mercado você encontra na Nobre Comércio e Serviço de Minerais
                </p>
                ...
                <a 
                  href="https://api.whatsapp.com/send/?phone=5521965691913&text=Olá, gostaria de solicitar um orçamento para Areia Ensacada&type=phone_number&app_absent=0"
                  target="_blank"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="font-sans text-gray-300 leading-relaxed">
                    Obter insumos para a construção civil é uma etapa muito importante para a reforma ou construção de casas, edifícios e demais estabelecimentos. Há alguns produtos essenciais, como a areia que possui diferentes espessuras e nomenclaturas.
                  </p>
                  <p className="font-sans text-gray-300 leading-relaxed">
                    Utilizado para o preparo da massa para fazer estruturas de concreto, a areia ensacada possui altíssima qualidade e pode ser utilizada em diversos projetos de construção. Nós da Nobre Comércio e Serviços de Minerais buscamos sempre promover o completo atendimento aos nossos clientes, por isso trabalhamos com o melhor custo-benefício na Venda de Areia Ensacada.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-end">
              <img
                src="/lovable-uploads/nobre/Nobre-Minerais-Venda-de-Areia-Ensacada-01.png"
                alt="Areia Ensacada - Nobre Minerais"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-sans text-gray-300 leading-relaxed mb-8">
              Mantemos o nosso profissionalismo na Venda de Areia Ensacada para promover o melhor atendimento aos nossos clientes. A Nobre Comércio e Serviços de Minerais conta com uma equipe preparada para te atender da melhor maneira possível, de modo a esclarecer suas dúvidas e assim garantir que a Venda de Areia Ensacada seja eficiente.
            </p>
            <p className="font-sans text-gray-300 leading-relaxed">
              Trabalhamos com preço justo e compatível com a qualidade do nosso produto para que você não tenha dúvida quanto ao excelente negócio firmado com a nossa empresa.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="font-serif text-xl font-bold text-white mb-2">Estruturas de Concreto</h3>
                <p className="font-sans text-gray-300">Ideal para preparo de massa para estruturas resistentes.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Reformas</h3>
                <p className="font-sans text-gray-300">Perfeita para projetos de reforma e acabamento.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Construção Civil</h3>
                <p className="font-sans text-gray-300">Essencial para diversos projetos de construção.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-nobre-orange via-nobre-orange to-nobre-orange/90 text-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <p className="font-sans text-xl mb-8 opacity-90">
            Entre em contato conosco e receba o melhor preço para Areia Ensacada
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="https://api.whatsapp.com/send/?phone=5521995385789&text=Olá, gostaria de solicitar um orçamento para Areia Ensacada&type=phone_number&app_absent=0"
              target="_blank"
              rel="noopener noreferrer"
