            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-sans text-xl text-gray-300 mb-8 leading-relaxed">
                  O Rachão é um material de grande importância na construção civil, especialmente em obras que exigem alta resistência e suporte estrutural. Formado por pedras de maior granulometria, é muito utilizado em fundações, drenagens e contenções. A Venda de Rachão garante um insumo indispensável para a segurança e durabilidade de diversos tipos de projetos.
                </p>
                ...
                <a 
                  href="https://api.whatsapp.com/send/?phone=5521965691913&text=Olá, gostaria de solicitar um orçamento para Rachão&type=phone_number&app_absent=0"
                  target="_blank"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="font-sans text-gray-300 leading-relaxed">
                    A preparação correta do solo e das estruturas é fundamental para assegurar qualidade e estabilidade na construção. O Rachão é composto por pedras grandes e resistentes, que proporcionam excelente suporte mecânico e auxiliam no escoamento de água em áreas de drenagem.
                  </p>
                  <p className="font-sans text-gray-300 leading-relaxed">
                    Escolher fornecedores especializados na Venda de Rachão é garantir um material de alto padrão, bem selecionado e ideal para aplicações que exigem robustez.
                  </p>
                  <p className="font-sans text-gray-300 leading-relaxed">
                    A Nobre Comércio e Serviços de Minerais possui ampla experiência no fornecimento de materiais para a construção civil, entregando sempre qualidade, confiança e suporte especializado. Sempre que precisar de Rachão, conte conosco para receber soluções eficientes para sua obra.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="font-serif text-xl font-bold text-white mb-2">Fundações robustas</h3>
                <p className="font-sans text-gray-300">Fundação de obras e construções de grande porte.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Base para pavimentação</h3>
                <p className="font-sans text-gray-300">Base resistente para pavimentação de vias e estradas.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Sistemas de drenagem</h3>
                <p className="font-sans text-gray-300">Ideal para sistemas de drenagem e escoamento de água.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Muros de arrimo</h3>
                <p className="font-sans text-gray-300">Muros de arrimo e contenções de encostas.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300 md:col-span-2 lg:col-span-1">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Regularização</h3>
                <p className="font-sans text-gray-300">Regularização de terrenos instáveis e problemáticos.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-nobre-orange via-nobre-orange to-nobre-orange/90 text-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <p className="font-sans text-xl mb-8 opacity-90">
            Entre em contato conosco e receba o melhor preço para Rachão
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="https://api.whatsapp.com/send/?phone=5521995385789&text=Olá, gostaria de solicitar um orçamento para Rachão&type=phone_number&app_absent=0"
              target="_blank"
              rel="noopener noreferrer"
