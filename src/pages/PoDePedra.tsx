        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="font-serif text-xl font-bold text-white mb-2">Facilidade de Manuseio</h3>
              <p className="font-sans text-gray-300">Granulometria fina que facilita o manuseio e aplicação.</p>
            </div>
            <div className="text-center p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              <div className="bg-nobre-orange/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300">
              ...
              <p className="font-sans text-gray-300">Múltiplas aplicações em diversos processos construtivos.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="font-serif text-xl font-bold text-white mb-2">Nivelamento</h3>
                <p className="font-sans text-gray-300">Ideal para nivelamento de superfícies e terrenos.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Calçamento</h3>
                <p className="font-sans text-gray-300">Perfeito para base de calçadas e pisos externos.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Preparo de Massas</h3>
                <p className="font-sans text-gray-300">Excelente para preparo de massas especiais.</p>
              </div>
            </div>
          </div>
        </div>
