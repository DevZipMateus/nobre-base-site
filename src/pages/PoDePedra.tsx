            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="font-sans text-xl text-gray-300 mb-8 leading-relaxed">
                  O Pó de Pedra é um material amplamente utilizado na construção civil por sua versatilidade e eficiência em diversas aplicações. Sua granulometria fina garante excelente compactação e acabamento, sendo um insumo indispensável em muitas etapas da obra.
                </p>
                ...
                <a 
                  href="https://api.whatsapp.com/send/?phone=5521965691913&text=Olá, gostaria de solicitar um orçamento para Pó de Pedra&type=phone_number&app_absent=0"
                  target="_blank"
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="font-sans text-gray-300 leading-relaxed">
                    A escolha correta dos agregados miúdos é essencial para garantir resistência, estabilidade e qualidade na construção. O Pó de Pedra é resultado do processo de britagem, apresentando partículas finas que oferecem ótima compactação e desempenho técnico.
                  </p>
                  <p className="font-sans text-gray-300 leading-relaxed">
                    Contar com fornecedores especializados na Venda de Pó de Pedra é a certeza de adquirir um produto limpo, bem selecionado e pronto para atender às exigências da sua obra.
                  </p>
                  <p className="font-sans text-gray-300 leading-relaxed">
                    A Nobre Comércio e Serviços de Minerais é referência no fornecimento de agregados para a construção civil. Com ampla experiência no setor, trabalhamos sempre com foco na qualidade e na satisfação de nossos clientes. Quando precisar de Pó de Pedra, conte conosco para receber o melhor material e suporte de excelência.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="font-serif text-xl font-bold text-white mb-2">Concreto e argamassa</h3>
                <p className="font-sans text-gray-300">Produção de concreto e argamassa de alta qualidade.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Base para pavimentação</h3>
                <p className="font-sans text-gray-300">Base e regularização para pavimentação de alta resistência.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Pisos intertravados</h3>
                <p className="font-sans text-gray-300">Preparação de pisos intertravados com excelente acabamento.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Revestimentos asfálticos</h3>
                <p className="font-sans text-gray-300">Ideal para revestimentos asfálticos de qualidade superior.</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md p-6 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-300 md:col-span-2 lg:col-span-1">
                <CheckCircle className="w-8 h-8 text-nobre-orange mb-4" />
                <h3 className="font-serif text-xl font-bold text-white mb-2">Substituto da areia</h3>
                <p className="font-sans text-gray-300">Substituto da areia em algumas aplicações específicas.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-nobre-orange via-nobre-orange to-nobre-orange/90 text-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="https://api.whatsapp.com/send/?phone=5521995385789&text=Olá, gostaria de solicitar um orçamento para Pó de Pedra&type=phone_number&app_absent=0"
              target="_blank"
              rel="noopener noreferrer"
